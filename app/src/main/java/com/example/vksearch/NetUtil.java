...
public class NetUtil {
    ...
    public static URL generateURL(String userId) {
        Uri buildUri = Uri.parse(vk_api + vk_user_get).buildUpon().appendQueryParameter(user_id, userId).
                appendQueryParameter(version, "5.8").appendQueryParameter(token, "10259175b5475861292b276d0b2103f8a4fde6677edb8fee1002911529f0fcba84ad2cd1939662ba758a5").build();
        URL url = null;
        try {
